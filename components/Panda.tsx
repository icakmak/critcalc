      ...
      <Card className="w-full gap-2">
        ...
        <CardContent className="flex flex-row">
          ...
          <div className="flex lg:w-full sm:w-3/4 flex-col gap-2 ">
            <Button
              variant="outline"
              className="lg:w-80 sm:w-full font-bold flex lg:flex-row sm:flex-col justify-start"
              onClick={() => {
                setHesap(hesap + 0);
            ...
            <Button
              variant="outline"
              className="lg:w-80 sm:w-full font-bold flex lg:flex-row sm:flex-col gap-2 lg:h-10 sm:h-14 justify-start"
              onClick={() => {
                setHesap(hesap + 5);
                setBtnClick(!btnClick);
              }}
